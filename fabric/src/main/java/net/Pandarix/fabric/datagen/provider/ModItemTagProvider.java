...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider
{
    ...
    protected void addTags(HolderLookup.Provider pProvider)
    {
        ...
        // own tag instead of #c:elytras directly, so packs can widen it to modded gliding armour
        this.tag(ModTags.Items.SOARING_WINDS_ITEMS)
                .addOptionalTag(ModTags.Items.ELYTRAS.location());
        ...
        this.tag(ModTags.Items.MUSIC_DISCS)
